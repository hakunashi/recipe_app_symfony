 ...
 */
final class Version20240606135719 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX email ON newsletter_email');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE UNIQUE INDEX email ON newsletter_email (email)');
    }
}
